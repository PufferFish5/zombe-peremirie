...
print(plot(M1, forecast_M1) + add_changepoints_to_plot(M1))
dev.off()
...
print(plot(M2, forecast_M2) + add_changepoints_to_plot(M2))
dev.off()
...
print(plot(M3, forecast_M3) + add_changepoints_to_plot(M3))
dev.off()
...
print(plot(M4, forecast_M4) + add_changepoints_to_plot(M4))
dev.off()
